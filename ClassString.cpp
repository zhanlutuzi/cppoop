...
String::String(const char *str)
{
	...
	else
	{
		...
		strcpy(m_data, str);//C 库函数 - strcpy()   
...
String& String::operator=(const String &str)  // 输入参数为const
{
	...
	m_size = strlen(str.m_data);    //c库 strlen 函数
	m_data = new char[m_size + 1];  //对m_data加NULL 判断
	strcpy(m_data, str.m_data);
...
int main()
{
	...
	cout << "str1= ";
	cout << str1<<endl;
	cout << "Create a object str2,give it 123\n";
	cout << "str2= ";
	cout << str2<<endl;
	cout << "replace str1 as str2  str2=str1\n";
	str2 = str1;
	cout << "Here is the new str2\n";
	cout << str2<<endl;
	return 0;
}
